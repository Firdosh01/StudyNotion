      ...
      <div>
        <section className="bg-richblack-700">
          <div className="relative flex flex-col justify-between w-11/12 gap-10 mx-auto text-center text-white max-w-maxContent ">
            <header className="py-20 mx-auto text-4xl font-semibold lg:w-[70%]">
              Driving Innovation in Online Education for a
              <HighlightText text={"Brighter Future"} />
              <p className="text-richblack-300 lg:w-[95%] text-center mx-auto mt-3 text-base font-medium">
                CourseNexus is at the forefront of driving innovation in online
            ...
            <div className="bottom-0 left-[50%] absolute grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
          ...
          <div className="flex flex-col justify-between w-11/12 gap-10 mx-auto max-w-maxContent text-richblack-500">
            <div className="flex flex-col items-center justify-between gap-10 lg:flex-row">
              <div className="flex my-24 lg:w-[50%] flex-col gap-10">
                <h1 className="bg-gradient-to-br from-[#833AB4] vie-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%]">
                  Our Founding Story
                </h1>
